...
$(function () {
    ...
    $("#div_nav li").click(function () {
        $("#div_nav li a").removeClass("on");
        $(this).find("a").addClass("on");
        $(".div_sections section").removeClass("on");
        $(".div_sections section:eq(" + $(this).attr("data-idx") + ")").addClass("on");
    });
    ...
    $(".spec").click(function () {
        ...
        if (typeof (n) != "undefined") {
            ...
            if (parseFloat(oldPrice) >= parseFloat(price))
                $("#label_price_original label").parent().parent().show();
            else
                $("#label_price_original label").parent().parent().hide();
            // 库存
    ...
    $("#btn_add_shopcart").click(function () {
        ...
        $.post("/index.php?m=Home&c=Order&a=addGoodsCar", {
            "id": $("#gid").val(),
    ...
    $("#btn_buy").click(function () {
        ...
        a.sort();
        window.location.href = "/index.php?m=Home&c=Order&a=createOrder&type=goods&code=" + $("#gid").val() + "&sp=" + a.join("_") + "&cn=" + $("#sku_number").val();
    });
    getCarCnt();
});
