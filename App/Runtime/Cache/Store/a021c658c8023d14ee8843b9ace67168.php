        ...
        <a href="javascript:;" class="remove">
            <i class="fa fa-times"></i>
                                        ...
                                        <div class="contentbox">
                                            <form id="form1" name="form1" method="post" action="<?php echo U('Store/GoodsBrand/addBrandList');?>" enctype="multipart/form-data">
