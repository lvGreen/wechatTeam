            ...
            <i class="fa fa-times"></i>
                                        ...
                                        <div id="mainss" class="main" style="height: 969px; padding-top: 1px;">
                                            <div class="contentbox">
                                                <form action="<?php echo U('Store/Banner/addBanner');?>" method="post" enctype="multipart/form-data" name="theForm" id="theForm">
                                                    <div class="menu_content">
                                                        <table cellspacing="2" cellpadding="5" width="100%" id="tab1">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="label">banner名称：</td>
                                                                    <td>
                                                                        <input name="banner_name" id="goods_name" type="text" size="43" value="" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <img src='' />
                                                                        <input name="banner_pic" type="file" value="" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
