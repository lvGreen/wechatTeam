                                        ...
                                        <div id="mainss" class="main" style="height:auto; padding-top:1px;">
                                            <div class="contentbox">
                                                <table cellspacing="2" cellpadding="5" width="100%">
                                                    ...
                                                    <?php if(is_array($newsList)): $i = 0; $__LIST__ = $newsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo U('Store/News/newsAdd',array('id'=>$item['id']));?>" title="编辑">
...
<script type='text/javascript'>
    $(function(){
        $('.changeStatus').click(function(){
            ...
            $.post("<?php echo U('Store/News/changeNewsStatus');?>",{'NewsId':classId}, function(data){
                data = eval(data);
                if(data['error'] == '0'){
                    alert('修改状态成功！');
        ...
        $('#bathdel').click(function(){
            if(confirm("确定修改状态吗？考虑清楚了吗？")){
                ...
                var str = arr.join('+');
                $.post("<?php echo U('Store/News/changeNewsStatus');?>",{'NewsId':str},function(data){
                    data = eval(data);
                    alert(data['msg']);
                });
            }
