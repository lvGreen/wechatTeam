...
<script>
    ...
    <style>
        .templeClass{width:300px;display:block;float:left;}
    </style>
</head>
<body>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top">
                                                                <ul>
                                                                    <li rel='1' class='templeClass'>
                                                                        <img src='http://www.zmnkj.net/admin/images/muban/24.png' />
                                                                        <p class="bgs"></p>
                                                                        <?php if($themeId == '1' ): ?><p class="font" style='padding-left:90px;'>当前选择模板</p><?php endif; ?>
                                                                    </li>
                                                                    <li rel='2' class='templeClass'>
                                                                        <img src='http://www.zmnkj.net/admin/images/muban/24.png' />
                                                                        <p class="bgs"></p>
                                                                        <?php if($themeId == '2' ): ?><p class="font" style='padding-left:90px;'>当前选择模板</p><?php endif; ?>
                                                                    </li>
                                                                    <li rel='3' class='templeClass'>
                                                                        <img src='http://www.zmnkj.net/admin/images/muban/24.png' />
                                                                        <p class="bgs"></p>
                                                                        <?php if($themeId == '3' ): ?><p class="font" style='padding-left:90px;'>当前选择模板</p><?php endif; ?>
                                                                    </li>
                                                                </ul>
                                                            </td>
                                                        </tr>
...
<script type='text/javascript'>
    $(function () {
        $('.templeClass').click(function(){
            var themeId= $(this).attr('rel');
            $.post("<?php echo U('Store/Template/changeThemeId');?>", {'theme': themeId}, function(data){
                data = eval(data);
                if(data['error'] == '0'){
                    alert(data['msg']);
                    location.reload();
